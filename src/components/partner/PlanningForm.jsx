      ...
      <div className="max-w-2xl mx-auto px-5">
        ...
        >
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button
              type="submit"
              className="w-full h-10 rounded-xl bg-[#0B1F33] text-white font-semibold text-[14px] hover:bg-[#132238] transition-colors flex items-center justify-center gap-2"
            >
              Get started
