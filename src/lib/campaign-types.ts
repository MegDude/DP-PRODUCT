/**
 * Campaign Demo Type System
 * Data contracts for all campaign pages
 * Used by: exemplar pages, map demo, modules
 * Do NOT modify without updating all consuming pages
 */
